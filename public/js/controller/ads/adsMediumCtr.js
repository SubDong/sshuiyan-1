define(["./module"], function (ctrs) {
    "use strict";
    ctrs.controller("adsMediumCtr", function ($scope, $rootScope, $http, requestService, messageService, areaService, uiGridConstants, $cookieStore) {
