...
define(["./../module"], function (ctrs) {
    ...
    ctrs.controller('alliance_cy_ctr', function ($scope, $rootScope, $q, requestService, areaService, $http, uiGridConstants, $cookieStore, SEM_API_URL) {
        //        高级搜索提示
...
//        取消显示的高级搜索的条件
        ...
        //配置默认指标
        $rootScope.checkedArray = ["uv", "cost", "acp", "arrivedRate", "avgTime", "nuvRate"];
