...
//        取消显示的高级搜索的条件
        ...
        $rootScope.gridArray = [
            ...
            {
                name: " ",
                cellTemplate: "<div class='table_box'><a ui-sref='history13' ng-click='grid.appScope.getHistoricalTrend(this)' target='_parent' class='table_nextbtn' title='查看历史趋势'></a></div>",
                enableSorting: false
            },
            {
                name: "浏览量(PV)",
...
//            $rootScope.targetSearch();
        ...
        $scope.generatePDFMakeData = function (cb) {
            ...
            var docDefinition = {
                header: {
                    text: "Access Page - Entry Page Analysis Data Report",
                    style: "header",
                    alignment: 'center'
                },
                content: [
