...
define(["./../module"], function (ctrs) {
    ...
    ctrs.controller("newvisitorsctr", function ($scope, $rootScope, $http, requestService, messageService, areaService, uiGridConstants, popupService) {
        ...
        $rootScope.gridArray = [
            ...
            {
                name: " ",
                cellTemplate: "<div class='table_box'><button onmousemove='getMyButton(this)' class='table_btn'></button><div class='table_win'><ul style='color: #45b1ec'><li><a ng-click='grid.appScope.getHistoricalTrend(this, \"history9\")' target='_parent' target='_blank'>查看历史趋势</a></li><li><a ng-click='grid.appScope.showSourceDistribution(row)'>查看来源分布</a></li></ul></div></div>",
                enableSorting: false
            },
            {
                name: "访客数(UV)",
