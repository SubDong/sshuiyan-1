    ...
    ctrs.controller('flowanalysisctr', function ($scope, $rootScope, $http, requestService, messageService, areaService, uiGridConstants, popupService) {
        ...
        $rootScope.gridArray = [
            ...
            },
            {
                ...
                "<ul style='color: #45b1ec'><li><a ng-click='grid.appScope.getHistoricalTrend(this, \"history8\")' target='_parent' target='_blank'>查看历史趋势</a></li>" +
        ...
        $rootScope.tableSwitch = {
            ...
            coding: "<li><a ng-click='grid.appScope.getHistoricalTrend(this, \"history\")' target='_parent' target='_blank'>查看历史趋势</a></li>" +
...
//            $rootScope.targetSearch();
        ...
        $scope.generatePDFMakeData = function (cb) {
            ...
            var docDefinition = {
                header: {
                    text: "Entrance Page -  Network Flow Analysis Data Report",
                    style: "header",
                    alignment: 'center'
                },
                content: [
