...
!function () {
    ...
    var e = {priority: 0, scope: !1, require: "?^uiGrid", compile: function () {
    ...
    angular.module("ui.grid").service("uiGridColumnMenuService", ["i18nService", "uiGridConstants", "gridUtil", function (a, b, c) {
        ...
        var e = {priority: 0, scope: !0, require: "?^uiGrid", templateUrl: "ui-grid/uiGridColumnMenu", replace: !0, link: function (b, e, f, g) {
            var h = this;
    ...
    angular.module("ui.grid").directive("uiGridFooterCell", ["$timeout", "gridUtil", "uiGridConstants", "$compile", function (a, b, c, d) {
        var e = {priority: 0, scope: {col: "=", row: "=", renderIndex: "="}, replace: !0, require: "^uiGrid", compile: function (a, b, e) {
            return{pre: function (a, b, c, e) {
                ...
                var f, g = function (c) {
                    var d = b;
                    f && (d.removeClass(f), f = null), f = angular.isFunction(a.col.footerCellClass) ? a.col.footerCellClass(a.grid, a.row, a.col, a.rowRenderIndex, a.colRenderIndex) : a.col.footerCellClass, d.addClass(f)
                };
    ...
    angular.module("ui.grid").directive("uiGridFooter", ["$templateCache", "$compile", "uiGridConstants", "gridUtil", "$timeout", function (a, b, c, d, e) {
        ...
        return{restrict: "EA", replace: !0, require: ["^uiGrid", "^uiGridRenderContainer"], scope: !0, compile: function (a, c) {
            return{pre: function (a, c, e, g) {
                var h = g[0], i = g[1];
    ...
    angular.module("ui.grid").directive("uiGridGridFooter", ["$templateCache", "$compile", "uiGridConstants", "gridUtil", "$timeout", function (a, b, c, d, e) {
        var f = "ui-grid/ui-grid-grid-footer";
        return{restrict: "EA", replace: !0, require: "^uiGrid", scope: !0, compile: function (a, c) {
            return{pre: function (a, c, e, g) {
                a.grid = g.grid;
                var h = a.grid.options.gridFooterTemplate ? a.grid.options.gridFooterTemplate : f;
    ...
    angular.module("ui.grid").directive("uiGridGroupPanel", ["$compile", "uiGridConstants", "gridUtil", function (a, b, c) {
        ...
        return{restrict: "EA", replace: !0, require: "?^uiGrid", scope: !1, compile: function (b, e) {
            return{pre: function (b, e, f, g) {
    ...
    angular.module("ui.grid").directive("uiGridHeaderCell", ["$compile", "$timeout", "$window", "$document", "gridUtil", "uiGridConstants", "ScrollEvent", function (a, b, c, d, e, f, g) {
        var h = 500, i = 500, j = {priority: 0, scope: {col: "=", row: "=", renderIndex: "="}, require: ["?^uiGrid", "^uiGridRenderContainer"], replace: !0, compile: function () {
            return{pre: function (b, c, d) {
                ...
                var m, n = (angular.element(c[0].querySelectorAll(".ui-grid-header-cell-menu")), angular.element(c[0].querySelectorAll(".ui-grid-cell-contents")));
                a.downFn = function (e) {
                    e.stopPropagation(), "undefined" != typeof e.originalEvent && void 0 !== e.originalEvent && (e = e.originalEvent), e.button && 0 !== e.button || (a.mousedownStartTime = (new Date).getTime(), a.mousedownTimeout = b(function () {
                    }, h), a.mousedownTimeout.then(function () {
                        a.colMenu && j.columnMenuScope.showMenu(a.col, c, e)
                    }), j.fireEvent(f.events.COLUMN_HEADER_CLICK, {event: e, columnName: a.col.colDef.name}), a.offAllEvents(), "touchstart" === e.type ? (d.on("touchend", a.upFn), d.on("touchmove", a.moveFn)) : "mousedown" === e.type && (d.on("mouseup", a.upFn), d.on("mousemove", a.moveFn)))
                }, a.upFn = function (c) {
                    ...
                    b.cancel(a.mousedownTimeout), a.offAllEvents(), a.onDownEvents(c.type)
                }, a.clickFn = function (b) {
                    b.stopPropagation(), n.off("click", a.clickFn)
                }, a.offAllEvents = function () {
                    n.off("touchstart", a.downFn), n.off("mousedown", a.downFn), d.off("touchend", a.upFn), d.off("mouseup", a.upFn), d.off("touchmove", a.moveFn), d.off("mousemove", a.moveFn), n.off("click", a.clickFn)
                }, a.onDownEvents = function (c) {
                    switch (c) {
                        case"touchmove":
                        case"touchend":
                            n.on("click", a.clickFn), n.on("touchstart", a.downFn), b(function () {
                                n.on("mousedown", a.downFn)
                            }, i);
                            break;
                        case"mousemove":
                        case"mouseup":
                            n.on("click", a.clickFn), n.on("mousedown", a.downFn), b(function () {
                                n.on("touchstart", a.downFn)
                            }, i);
                            break;
                        default:
                            n.on("click", a.clickFn), n.on("touchstart", a.downFn), n.on("mousedown", a.downFn)
                    }
                };
                var o = function (b) {
                    var d = c;
                    ...
                    a.isLastCol = a.col === e.visibleColumnCache[e.visibleColumnCache.length - 1], a.sortable = j.grid.options.enableSorting && a.col.enableSorting ? !0 : !1, a.filterable = j.grid.options.enableFiltering && a.col.enableFiltering ? !0 : !1, a.colMenu = a.col.grid.options && a.col.grid.options.enableColumnMenus !== !1 && a.col.colDef && a.col.colDef.enableColumnMenu !== !1 ? !0 : !1, a.offAllEvents(), (a.sortable || a.colMenu) && (a.onDownEvents(), a.$on("$destroy", function () {
                        a.offAllEvents()
                    }));
                    var f = [];
                    a.filterable ? (a.col.filters.forEach(function (b, c) {
                        f.push(a.$watch("col.filters[" + c + "].term", function (a, b) {
                ...
                a.$on("$destroy", p), a.handleClick = function (b) {
                    var c = !1;
    ...
    "use strict";
    angular.module("ui.grid").directive("uiGridHeader", ["$templateCache", "$compile", "uiGridConstants", "gridUtil", "$timeout", function (a, b, c, d, e) {
        var f = "ui-grid/ui-grid-header", g = "ui-grid/ui-grid-no-header";
        return{restrict: "EA", replace: !0, require: ["^uiGrid", "^uiGridRenderContainer"], scope: !0, compile: function (a, c) {
            return{pre: function (a, c, e, h) {
                function i() {
                ...
                var l;
                l = a.grid.options.showHeader ? a.grid.options.headerTemplate ? a.grid.options.headerTemplate : f : g, d.getTemplate(l).then(function (d) {
                    var e = angular.element(d), f = b(e)(a);
    ...
    angular.module("ui.grid").service("uiGridGridMenuService", ["gridUtil", "i18nService", "uiGridConstants", function (a, b, c) {
        var d = {initialize: function (a, b) {
            ...
            return a.grid.options.columnDefs && 0 !== a.grid.options.columnDefs.length && 0 !== a.grid.columns.length ? (c.push({title: b.getSafeText("gridMenu.columns")}), a.grid.options.gridMenuTitleFilter = a.grid.options.gridMenuTitleFilter ? a.grid.options.gridMenuTitleFilter : function (a) {
                ...
                if (b.enableHiding !== !1) {
                    var f = {icon: "ui-grid-icon-ok", action: function (a) {
                    ...
                    }, context: {gridCol: a.grid.getColumn(b.name || b.field)}, leaveOpen: !0};
                    d.setMenuItemTitle(f, b, a.grid), c.push(f), f = {icon: "ui-grid-icon-cancel", action: function (a) {
                        a.stopPropagation(), d.toggleColumnVisibility(this.context.gridCol)
                    }, shown: function () {
                        return!(this.context.gridCol.colDef.visible === !0 || void 0 === this.context.gridCol.colDef.visible)
                    }, context: {gridCol: a.grid.getColumn(b.name || b.field)}, leaveOpen: !0}, d.setMenuItemTitle(f, b, a.grid), c.push(f)
                }
            }), c) : c
        ...
        return{priority: 0, scope: !0, require: ["?^uiGrid"], templateUrl: "ui-grid/ui-grid-menu-button", replace: !0, link: function (a, b, d, e) {
            var f = e[0];
    ...
    angular.module("ui.grid").directive("uiGridMenu", ["$compile", "$timeout", "$window", "$document", "gridUtil", "uiGridConstants", function (a, b, c, d, e, f) {
        var g = {priority: 0, scope: {menuItems: "=", autoHide: "=?"}, require: "?^uiGrid", templateUrl: "ui-grid/uiGridMenu", replace: !1, link: function (a, d, e, g) {
            var h = this;
        ...
        var d = {priority: 0, scope: {name: "=", active: "=", action: "=", icon: "=", shown: "=", context: "=", templateUrl: "=", leaveOpen: "="}, require: ["?^uiGrid", "^uiGridMenu"], templateUrl: "ui-grid/uiGridMenuItem", replace: !0, compile: function (d, e) {
            return{pre: function (c, d, e, f) {
                f[0], f[1];
        ...
        return{replace: !0, transclude: !0, templateUrl: "ui-grid/uiGridRenderContainer", require: ["^uiGrid", "uiGridRenderContainer"], scope: {containerId: "=", rowContainerName: "=", colContainerName: "=", bindScrollHorizontal: "=", bindScrollVertical: "=", enableVerticalScrollbar: "=", enableHorizontalScrollbar: "="}, controller: "uiGridRenderContainer as RenderContainer", compile: function () {
            return{pre: function (a, b, c, d) {
                ...
                function g(b) {
                    if (!b.grid || b.grid.id === k.id) {
                        ...
                        if (b.x && a.bindScrollHorizontal) {
                            ...
                            a.newScrollLeft = f, j.headerViewport && (j.headerViewport.scrollLeft = d.denormalizeScrollLeft(j.headerViewport, f)), j.footerViewport && (j.footerViewport.scrollLeft = d.denormalizeScrollLeft(j.footerViewport, f)), b.source !== e.Sources.ViewPortScroll && (j.viewport[0].scrollLeft = d.denormalizeScrollLeft(j.viewport, f)), j.prevScrollLeft = f
                        }
                    }
                }

                function h() {
                    var b = "", c = m.canvasWidth, d = m.getViewportWidth(), e = l.getCanvasHeight();
                ...
                b.addClass("ui-grid-render-container-" + a.containerId), (a.bindScrollHorizontal || a.bindScrollVertical) && k.api.core.on.scrollEvent(a, g), d.on.mousewheel(b, function (a) {
                    ...
                    (b.y && 0 !== b.y.percentage && 1 !== b.y.percentage && 0 !== j.viewport[0].scrollTop || b.x && 0 !== b.x.percentage && 1 !== b.x.percentage) && (a.preventDefault(), b.fireThrottledScrollingEvent())
                }), b.bind("$destroy", function () {
    ...
    angular.module("ui.grid").directive("uiGridViewport", ["gridUtil", "ScrollEvent", "uiGridConstants", function (a, b, c) {
        return{replace: !0, scope: {}, controllerAs: "Viewport", templateUrl: "ui-grid/uiGridViewport", require: ["^uiGrid", "^uiGridRenderContainer"], link: function (d, e, f, g) {
            var h = g[0], i = g[1];
            d.containerCtrl = i;
            var j = i.rowContainer, k = i.colContainer, l = h.grid;
            d.grid = h.grid, d.rowContainer = i.rowContainer, d.colContainer = i.colContainer, i.viewport = e, e.on("scroll", function (d) {
                var f = e[0].scrollTop, g = a.normalizeScrollLeft(e), h = -1, i = -1;
                if (g !== k.prevScrollLeft) {
                    l.flagScrollingHorizontally();
                    var m = g - k.prevScrollLeft;
                    m > 0 && (l.scrollDirection = c.scrollDirection.RIGHT), 0 > m && (l.scrollDirection = c.scrollDirection.LEFT);
                    var n = k.getCanvasWidth() - k.getViewportWidth();
                    h = 0 !== n ? g / n : 0, k.adjustScrollHorizontal(g, h)
                }
                if (f !== j.prevScrollTop) {
                    l.flagScrollingVertically();
                    var o = f - j.prevScrollTop;
                    o > 0 && (l.scrollDirection = c.scrollDirection.DOWN), 0 > o && (l.scrollDirection = c.scrollDirection.UP);
                    var p = j.getVerticalScrollLength();
                    i = f / p, i > 1 && (i = 1), 0 > i && (i = 0), j.adjustScrollVertical(f, i)
                }
                var q = new b(l, j, k, b.Sources.ViewPortScroll);
                q.newScrollLeft = g, q.newScrollTop = f, h > -1 && (q.x = {percentage: h}), i > -1 && (q.y = {percentage: i}), q.fireScrollingEvent()
            })
        }, controller: ["$scope", function (a) {
    ...
    angular.module("ui.grid").controller("uiGridController", ["$scope", "$element", "$attrs", "gridUtil", "$q", "uiGridConstants", "$templateCache", "gridClassFactory", "$timeout", "$parse", "$compile", function (a, b, c, d, e, f, g, h, i, j, k) {
        ...
        function m(b) {
            var d = [];
            b && (n.grid.columns.length === (n.grid.rowHeaderColumns ? n.grid.rowHeaderColumns.length : 0) && !c.uiGridColumns && 0 === n.grid.options.columnDefs.length && b.length > 0 && n.grid.buildColumnDefsFromData(b), (n.grid.options.columnDefs.length > 0 || b.length > 0) && d.push(n.grid.buildColumns().then(function () {
        ...
        return{templateUrl: "ui-grid/ui-grid", scope: {uiGrid: "="}, replace: !0, transclude: !0, controller: "uiGridController", compile: function () {
            return{post: function (a, b, f, g) {
                function h(d) {
                    i.gridWidth = a.gridWidth = c.elementWidth(b), i.gridHeight = a.gridHeight = c.elementHeight(b), i.refreshCanvas(!0)
                }

                var i = g.grid;
                if (g.scrollbars = [], i.renderingComplete(), i.element = b, i.gridWidth = a.gridWidth = c.elementWidth(b), i.canvasWidth = g.grid.gridWidth, i.gridHeight = a.gridHeight = c.elementHeight(b), i.gridHeight < i.options.rowHeight && i.options.enableMinHeightCheck) {
    ...
    angular.module("ui.grid").directive("uiGridPinnedContainer", ["gridUtil", function (a) {
        return{restrict: "EA", replace: !0, template: '<div class="ui-grid-pinned-container"><div ui-grid-render-container container-id="side" row-container-name="\'body\'" col-container-name="side" bind-scroll-vertical="true" class="{{ side }} ui-grid-render-container-{{ side }}"></div></div>',
            scope: {side: "=uiGridPinnedContainer"}, require: "^uiGrid", compile: function () {
    ...
    angular.module("ui.grid").factory("Grid", ["$q", "$compile", "$parse", "gridUtil", "uiGridConstants", "GridOptions", "GridColumn", "GridRow", "GridApi", "rowSorter", "rowSearcher", "GridRenderContainer", "$timeout", function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
        ...
        return o.prototype.calcFooterHeight = function () {
            ...
            return h
        }, o.prototype.callDataChangeCallbacks = function (a, b) {
            ...
            if (f.rowHeaderColumns.forEach(function (a) {
                ...
                for (e = 0; k > e; e++)j[e + i] = f.columns[e + i].name !== f.options.columnDefs[e].name ? f.getColumn(f.options.columnDefs[e].name) : f.columns[e + i];
            ...
            this.columns.forEach(function (c) {
                ...
                d = d.replace(e.COL_FIELD, "grid.getCellValue(row, col)"), d = c.cellTooltip === !1 ? d.replace(e.TOOLTIP, "") : d.replace(e.TOOLTIP, 'title="{{col.cellTooltip(row, col)}}"');
                var f = b(d);
            ...
            return f
        }, o.prototype.getRow = function (a, b) {
            var c = this;
        ...
        }, o.prototype.handleWindowResize = function (a) {
            var b = this;
            ...
            return this.options.flatEntityAccess && b.field ? a.entity[b.field] : (b.cellValueGetterCache || (b.cellValueGetterCache = c(a.getEntityQualifiedColField(b))), b.cellValueGetterCache(a))
            ...
            return m(f.length > 0 ? function () {
                ...
                for (a = 0; a < f.length; a++)if (g = f[a], null !== g.canvasWidth && !isNaN(g.canvasWidth)) {
                    if (g.header) {
                        var k = g.headerHeight, l = g.headerHeight = parseInt(d.outerElementHeight(g.header), 10);
                        k !== l && (h = !0);
                    ...
                    if (g.headerCanvas) {
                        var p = g.headerCanvasHeight, q = g.headerCanvasHeight = parseInt(d.outerElementHeight(g.headerCanvas), 10);
                        p !== q && (h = !0), !g.explicitHeaderCanvasHeight && q > j && (j = q)
                    }
                }
                for (a = 0; a < f.length; a++)g = f[a], i > 0 && "undefined" != typeof g.headerHeight && null !== g.headerHeight && (g.explicitHeaderHeight || g.headerHeight < i) && (g.explicitHeaderHeight = i), j > 0 && "undefined" != typeof g.headerCanvasHeight && null !== g.headerCanvasHeight && (g.explicitHeaderCanvasHeight || g.headerCanvasHeight < j) && (g.explicitHeaderCanvasHeight = j);
    ...
    angular.module("ui.grid").factory("GridApi", ["$q", "$rootScope", "gridUtil", "uiGridConstants", "GridRow", "uiGridGridMenuService", function (a, b, c, d, e, f) {
        ...
        return h.prototype.suppressEvents = function (a, b) {
        ...
        }, h.prototype.registerEvent = function (a, c) {
            var d = this;
            d[a] || (d[a] = {});
            var e = d[a];
            e.on || (e.on = {}, e.raise = {});
            var f = d.grid.id + a + c;
            e.raise[c] = function () {
                b.$emit.apply(b, [f].concat(Array.prototype.slice.call(arguments)))
            }, e.on[c] = function (a, b, c) {
                var e = g(f, b, d.grid, c), h = {handler: b, dereg: e, eventId: f, scope: a, _this: c};
                d.listeners.push(h);
                var i = function () {
                    h.dereg();
    ...
    angular.module("ui.grid").factory("GridColumn", ["gridUtil", "uiGridConstants", "i18nService", function (a, b, c) {
        ...
        return d.prototype.setPropertyOrDefault = function (a, b, c) {
            ...
            e.minWidth = b.minWidth ? b.minWidth : 30, e.maxWidth = b.maxWidth ? b.maxWidth : 9e3, e.field = void 0 === b.field ? b.name : b.field, "string" != typeof e.field && a.logError("Field is not a string, this is likely to break the code, Field is: " + e.field), e.name = b.name, e.displayName = void 0 === b.displayName ? a.readableColumnName(b.name) : b.displayName, e.aggregationType = angular.isDefined(b.aggregationType) ? b.aggregationType : null, e.footerCellTemplate = angular.isDefined(b.footerCellTemplate) ? b.footerCellTemplate : null, e.cellTooltip = "undefined" == typeof b.cellTooltip || b.cellTooltip === !1 ? !1 : b.cellTooltip === !0 ? function (a, b) {
                return e.grid.getCellValue(a, b)
            } : b.cellTooltip, e.footerCellClass = b.footerCellClass, e.cellClass = b.cellClass, e.headerCellClass = b.headerCellClass, e.cellFilter = b.cellFilter ? b.cellFilter : "", e.headerCellFilter = b.headerCellFilter ? b.headerCellFilter : "", e.footerCellFilter = b.footerCellFilter ? b.footerCellFilter : "", e.visible = a.isNullOrUndefined(b.visible) || b.visible, e.headerClass = b.headerClass, e.enableSorting = "undefined" != typeof b.enableSorting ? b.enableSorting : !0, e.sortingAlgorithm = b.sortingAlgorithm, "undefined" == typeof e.suppressRemoveSort && (e.suppressRemoveSort = "undefined" != typeof b.suppressRemoveSort ? b.suppressRemoveSort : !1), e.enableFiltering = "undefined" != typeof b.enableFiltering ? b.enableFiltering : !0, e.setPropertyOrDefault(b, "menuItems", []), c && e.setPropertyOrDefault(b, "sort");
            var i = [];
            b.filter ? i.push(b.filter) : b.filters ? i = b.filters : i.push({}), c ? (e.setPropertyOrDefault(b, "filter"), e.setPropertyOrDefault(b, "filters", i)) : e.filters.length === i.length && e.filters.forEach(function (a, b) {
                "undefined" != typeof i[b].placeholder && (a.placeholder = i[b].placeholder), "undefined" != typeof i[b].flags && (a.flags = i[b].flags), "undefined" != typeof i[b].type && (a.type = i[b].type), "undefined" != typeof i[b].selectOptions && (a.selectOptions = i[b].selectOptions)
            ...
            var a = this, c = 0, d = a.grid.getVisibleRows(), e = function () {
                ...
                return angular.forEach(d, function (c) {
                    var d = a.grid.getCellValue(c, a), e = Number(d);
                    isNaN(e) || b.push(e)
                }), b
            };
    ...
    angular.module("ui.grid").factory("GridRow", ["gridUtil", function (a) {
        ...
        return Object.defineProperty(b.prototype, "height", {get: function () {
            return this.$$height
        }, set: function (a) {
            ...
            delete this.invisibleReason.user, this.evaluateRowVisibility(b)
        }, b.prototype.evaluateRowVisibility = function (a) {
            var b = !0;
            this.invisibleReason && angular.forEach(this.invisibleReason, function (a, c) {
                a && (b = !1)
            }), this.visible !== b && (this.visible = b, a || (this.grid.queueGridRefresh(), this.grid.api.core.raise.rowsVisibleChanged(this)))
        }, b
    }])
}(), function () {
    angular.module("ui.grid").factory("ScrollEvent", ["gridUtil", function (a) {
        ...
        }, b.Sources = {ViewPortScroll: "ViewPortScroll", RenderContainerMouseWheel: "RenderContainerMouseWheel", RenderContainerTouchMove: "RenderContainerTouchMove", Other: 99}, b
    }])
}(), function () {
    "use strict";
    angular.module("ui.grid").service("gridClassFactory", ["gridUtil", "$q", "$compile", "$templateCache", "uiGridConstants", "Grid", "GridColumn", "GridRow", function (a, b, c, d, e, f, g, h) {
        var i = {createGrid: function (d) {
            ...
            }), e.registerRowsProcessor(e.searchRows), e.registerRowsProcessor(e.options.externalSort && angular.isFunction(e.options.externalSort) ? e.options.externalSort : e.sortByColumn), e
        }, defaultColumnBuilder: function (c, d, f) {
            var g = [];
            return d.providedHeaderCellTemplate = c.headerCellTemplate ? c.headerCellTemplate : "ui-grid/uiGridHeaderCell", d.providedCellTemplate = c.cellTemplate ? c.cellTemplate : "ui-grid/uiGridCell", d.providedFooterCellTemplate = c.footerCellTemplate ? c.footerCellTemplate : "ui-grid/uiGridFooterCell", d.cellTemplatePromise = a.getTemplate(d.providedCellTemplate), g.push(d.cellTemplatePromise.then(function (a) {
            ...
            })), g.push(a.getTemplate(d.providedHeaderCellTemplate).then(function (a) {
            ...
            })), g.push(a.getTemplate(d.providedFooterCellTemplate).then(function (a) {
            ...
            })), d.compiledElementFnDefer = b.defer(), b.all(g)
    ...
    b.service("rowSearcher", ["gridUtil", "uiGridConstants", function (b, c) {
        ...
        return e.getTerm = function (a) {
            ...
            for (var b = [], d = a.length, f = 0; d > f; f++) {
                ...
                if (g.noTerm || g.term) {
                    var h = {}, i = "";
                    g.flags && g.flags.caseSensitive || (i += "i"), g.term && (h.term = e.stripTerm(g)), h.condition = g.condition ? g.condition : e.guessCondition(g), h.flags = angular.extend({caseSensitive: !1, date: !1}, g.flags), h.condition === c.filter.STARTS_WITH && (h.startswithRE = new RegExp("^" + h.term, i)), h.condition === c.filter.ENDS_WITH && (h.endswithRE = new RegExp(h.term + "$", i)), h.condition === c.filter.CONTAINS && (h.containsRE = new RegExp(h.term, i)), h.condition === c.filter.EXACT && (h.exactRE = new RegExp("^" + h.term + "$", i)), b.push(h)
                }
            }
            return b
            ...
            if ("number" == typeof h) {
                var j = parseFloat(g.replace(/\\\./, ".").replace(/\\\-/, "-"));
                isNaN(j) || (g = j)
            }
    ...
    a.service("rowSorter", ["$parse", "uiGridConstants", function (a, b) {
        ...
        return d.guessSortFn = function (a) {
            ...
            var e;
            return d.colSortFnCache[b.colDef.name] ? e = d.colSortFnCache[b.colDef.name] : void 0 !== b.sortingAlgorithm ? (e = b.sortingAlgorithm, d.colSortFnCache[b.colDef.name] = b.sortingAlgorithm) : (e = d.guessSortFn(b.colDef.type), e ? d.colSortFnCache[b.colDef.name] = e : e = d.sortAlpha), e
            ...
            if (c) {
                ...
                var g, h, i = c.slice(0), j = function (a, b) {
    ...
    var g = new RegExp("^(" + /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source + ")(?!px)[a-z%]+$", "i"), h = /^(block|none|table(?!-c[ea]).+)/, i = {position: "absolute", visibility: "hidden", display: "block"}, j = ["0", "0", "0"], k = "uiGrid-";
    f.service("gridUtil", ["$log", "$window", "$document", "$http", "$templateCache", "$timeout", "$injector", "$q", "$interpolate", "uiGridConstants", function (b, f, g, l, m, n, o, p, q, r) {
        function s(a, b) {
            ...
            if (b.originalEvent && (b = b.originalEvent), "detail"in b && (f = -1 * b.detail), "wheelDelta"in b && (f = b.wheelDelta), "wheelDeltaY"in b && (f = b.wheelDeltaY), "wheelDeltaX"in b && (e = -1 * b.wheelDeltaX), "axis"in b && b.axis === b.HORIZONTAL_AXIS && (e = -1 * f, f = 0), d = 0 === f ? e : f, "deltaY"in b && (f = -1 * b.deltaY, d = f), "deltaX"in b && (e = b.deltaX, 0 === f && (d = -1 * e)), 0 !== f || 0 !== e) {
                ...
                var j = {originalEvent: b, deltaX: e, deltaY: f, deltaFactor: x, preventDefault: function () {
                    b.preventDefault()
                }};
        ...
        var v = {getStyles: a, createBoundedWrapper: function (a, b) {
            return function () {
        ...
        ["width", "height"].forEach(function (b) {
            ...
            var a = f.navigator.userAgent, b = {chrome: /chrome/i, safari: /safari/i, firefox: /firefox/i, ie: /internet explorer|trident\//i};
            for (var c in b)if (b[c].test(a))return c;
            return"unknown"
        }, v.rtlScrollType = function z() {
            ...
            return document.body.appendChild(a), a.scrollLeft > 0 ? b = "default" : (a.scrollLeft = 1, 0 === a.scrollLeft && (b = "negative")), a.remove(), z.type = b, b
        }, v.normalizeScrollLeft = function (a) {
            "undefined" != typeof a.length && a.length && (a = a[0]);
            var b = a.scrollLeft, c = v.getStyles(a).direction;
            if ("rtl" === c)switch (v.rtlScrollType()) {
                case"default":
                    return a.scrollWidth - b - a.clientWidth;
                case"negative":
                    return Math.abs(b);
                case"reverse":
                    return b
    ...
    b.constant("uiGridCellNavConstants", {FEATURE_NAME: "gridCellNav", CELL_NAV_EVENT: "cellNav", direction: {LEFT: 0, RIGHT: 1, UP: 2, DOWN: 3, PG_UP: 4, PG_DOWN: 5}, EVENT_TYPE: {KEYDOWN: 0, CLICK: 1, CLEAR: 2}}), b.factory("uiGridCellNavFactory", ["gridUtil", "uiGridConstants", "uiGridCellNavConstants", "$q", function (b, c, d, e) {
        ...
        var g = {initializeGrid: function (a) {
            ...
            var b = {events: {cellNav: {navigate: function (a, b) {
            }}}, methods: {cellNav: {scrollTo: function (b, c) {
                g.scrollTo(a, b, c)
            ...
            var d = null, e = null;
            null !== b && "undefined" != typeof b && (d = a.getRow(b)), null !== c && "undefined" != typeof c && (e = a.getColumn(c.name ? c.name : c.field)), this.scrollToIfNecessary(a, d, e)
        }, scrollToFocus: function (a, b, c) {
            var d = null, e = null;
            "undefined" != typeof b && null !== b && (d = a.getRow(b)), "undefined" != typeof c && null !== c && (e = a.getColumn(c.name ? c.name : c.field)), this.scrollToIfNecessary(a, d, e);
            var f = {row: d, col: e};
            ...
            h = 0 > h ? 0 : h;
            var i = a.renderContainers.body.prevScrollLeft, j = a.renderContainers.body.prevScrollTop + a.gridHeight - a.headerHeight - a.footerHeight, k = a.renderContainers.body.prevScrollLeft + Math.ceil(a.gridWidth);
            if (null !== b) {
        ...
        return{replace: !0, priority: -150, require: "^uiGrid", scope: !1, controller: function () {
        }, compile: function () {
            return{pre: function (b, f, g, h) {
                var i = b, j = h.grid;
                c.initializeGrid(j), h.cellNav = {}, h.cellNav.focusCell = function (a, b) {
                    ...
                    if (g) {
                        var i = h.grid.renderContainers[f].cellNav.getNextRowCol(b, g.row, g.col), k = h.grid.renderContainers[f].cellNav.getFocusableCols();
                        return b === d.direction.LEFT && i.col === k[k.length - 1] && i.row === g.row && a.keyCode === e.keymap.TAB && a.shiftKey ? (h.cellNav.clearFocus(), !0) : b !== d.direction.RIGHT || i.col !== k[0] || i.row !== g.row || a.keyCode !== e.keymap.TAB || a.shiftKey ? (i.eventType = d.EVENT_TYPE.KEYDOWN, c.scrollToIfNecessary(j, i.row, i.col), h.cellNav.broadcastCellNav(i), a.stopPropagation(), a.preventDefault(), !1) : (h.cellNav.clearFocus(), !0)
                    }
                }
            }, post: function (a, b, c, d) {
            }}
        }}
    }]), b.directive("uiGridRenderContainer", ["$timeout", "$document", "gridUtil", "uiGridConstants", "uiGridCellNavService", "uiGridCellNavConstants", function (a, b, c, d, e, f) {
        return{replace: !0, priority: -99999, require: ["^uiGrid", "uiGridRenderContainer", "?^uiGridCellnav"], scope: !1, compile: function () {
            return{post: function (c, d, f, g) {
                var h = g[0], i = g[1];
        ...
        return{priority: -150, restrict: "A", require: "^uiGrid", scope: !1, link: function (b, c, d, e) {
            function g() {
            ...
            e.grid.api.cellNav && b.col.colDef.allowCellFocus && (g(), c.find("div").on("click", function (c) {
                ...
                return a.eventType === f.EVENT_TYPE.CLEAR ? void i() : void(d.row === b.row && d.col === b.col ? (e.grid.options.modifierKeysToMultiSelectCells && g && -1 === e.grid.api.cellNav.rowColSelectIndex(d) ? i() : h(), d.hasOwnProperty("eventType") && d.eventType === f.EVENT_TYPE.KEYDOWN && c.find("div")[0].focus()) : e.grid.options.modifierKeysToMultiSelectCells && g || i())
    ...
    a.constant("uiGridEditConstants", {EDITABLE_CELL_TEMPLATE: /EDITABLE_CELL_TEMPLATE/g, EDITABLE_CELL_DIRECTIVE: /editable_cell_directive/g, events: {BEGIN_CELL_EDIT: "uiGridEventBeginCellEdit", END_CELL_EDIT: "uiGridEventEndCellEdit", CANCEL_CELL_EDIT: "uiGridEventCancelCellEdit"}}), a.service("uiGridEditService", ["$q", "$templateCache", "uiGridConstants", "gridUtil", function (a, b, c, d) {
        var e = {initializeGrid: function (a) {
            ...
            var b = {events: {edit: {afterCellEdit: function (a, b, c, d) {
            }, beginCellEdit: function (a, b) {
        ...
        var j = 500;
        return{priority: -100, restrict: "A", scope: !1, require: "?^uiGrid", link: function (f, k, l, m) {
            function n() {
                k.on("dblclick", u), k.on("keydown", s), f.col.colDef.enableCellEditOnFocus && k.find("div").on("focus", r), k.on("touchstart", o)
            }

            function o(a) {
                "undefined" != typeof a.originalEvent && void 0 !== a.originalEvent && (a = a.originalEvent), k.on("touchend", p), B = c(function () {
                }, j), B.then(function () {
                    setTimeout(u, 0), k.off("touchend", p)
                })
            }
            ...
            function q() {
                k.off("dblclick", u), k.off("keydown", s), f.col.colDef.enableCellEditOnFocus && k.find("div").off("focus", r), k.off("touchstart", o)
            }

            function r(a) {
                m && m.cellNav && m.cellNav.focusCell(f.row, f.col), a.stopPropagation(), u()
            }

            function s(a) {
                h.isStartEditKey(a) && u()
            }
            ...
            function u() {
                if (!D && t(f.col, f.row)) {
                    f.grid.api.cellNav && f.grid.api.cellNav.scrollToIfNecessary(f.row, f.col), A = g(f.row.getQualifiedColField(f.col)), z = A(f), y = f.col.editableCellTemplate, y = y.replace(d.MODEL_COL_FIELD, f.row.getQualifiedColField(f.col));
                    var b = f.col.colDef.editDropdownFilter ? "|" + f.col.colDef.editDropdownFilter : "";
                    y = y.replace(d.CUSTOM_FILTERS, b);
                    var c = "text";
                    ...
                    y = y.replace("INPUT_TYPE", c);
                    var h = f.col.colDef.editDropdownRowEntityOptionsArrayPath;
                    f.editDropdownOptionsArray = h ? x(f.row.entity, h) : f.col.colDef.editDropdownOptionsArray, f.editDropdownIdLabel = f.col.colDef.editDropdownIdLabel ? f.col.colDef.editDropdownIdLabel : "id", f.editDropdownValueLabel = f.col.colDef.editDropdownValueLabel ? f.col.colDef.editDropdownValueLabel : "value";
                    var j = function () {
                        D = !0, q();
                        var b = angular.element(y);
                        k.append(b), C = f.$new(), a(b)(C);
                        var c = angular.element(k.children()[0]);
                        E = c.hasClass("ui-grid-cell-focus"), c.addClass("ui-grid-cell-contents-hidden")
                    };
                    i.$$phase ? j() : f.$apply(j);
                    var l = f.col.grid.api.core.on.scrollEvent(f, function () {
                        v(!0), f.grid.api.edit.raise.afterCellEdit(f.row.entity, f.col.colDef, A(f), z), l(), m(), n()
                    }), m = f.$on(e.events.END_CELL_EDIT, function (a, b) {
                        v(b), f.grid.api.edit.raise.afterCellEdit(f.row.entity, f.col.colDef, A(f), z), m(), l(), n()
                    }), n = f.$on(e.events.CANCEL_CELL_EDIT, function () {
                        w(), n(), l(), m()
                    });
            ...
            function v(a) {
                if (D) {
                    var b = angular.element(k.children()[0]);
                    C.$destroy(), angular.element(k.children()[1]).remove(), b.removeClass("ui-grid-cell-contents-hidden"), a && E && b[0].focus(), E = !1, D = !1, n(), f.grid.api.core.notifyDataChange(d.dataChange.EDIT)
                }
            }

            function w() {
                D && (A.assign(f, z), f.$apply(), f.grid.api.edit.raise.cancelCellEdit(f.row.entity, f.col.colDef), v(!0))
            }
            ...
            if (f.col.colDef.enableCellEdit && f.row.enableCellEdit !== !1) {
                var y, z, A, B, C, D = !1, E = !1;
                n();
                try {
                    var F = b.get("uiGridCellNavConstants");
                    f.col.colDef.enableCellEditOnFocus && f.$on(F.CELL_NAV_EVENT, function (a, b) {
                        b.row === f.row && b.col === f.col ? c(function () {
                            c(function () {
                                u()
                            })
                        }) : v()
        ...
        return{scope: !0, require: ["?^uiGrid", "?^uiGridRenderContainer"], compile: function () {
        ...
        return{priority: -100, require: "?ngModel", link: function (c, d, e, f) {
    ...
    a.service("uiGridExpandableService", ["gridUtil", "$compile", function (a, b) {
        var c = {initializeGrid: function (b) {
            b.expandable = {}, b.expandable.expandedAll = !1, b.options.enableExpandable = b.options.enableExpandable !== !1, b.options.expandableRowHeight = b.options.expandableRowHeight || b.options.data.length * 30, b.options.expandableRowHeaderWidth = b.options.expandableRowHeaderWidth || 40, b.options.enableExpandable && !b.options.expandableRowTemplate && (a.logError("You have not set the expandableRowTemplate, disabling expandable module"), b.options.enableExpandable = !1);
            var d = {events: {expandable: {rowExpandedStateChanged: function (a, b) {
            }}}, methods: {expandable: {toggleRowExpansion: function (a) {
                var d = b.getRow(a);
        ...
        return{replace: !0, priority: 599, require: "^uiGrid", scope: !1, compile: function () {
            return{pre: function (a, b, c, d) {
        ...
        return{priority: -200, scope: !1, compile: function (a, b) {
            return{pre: function (a, b, c, d) {
    ...
    a.constant("uiGridExporterConstants", {featureName: "exporter", ALL: "all", VISIBLE: "visible", SELECTED: "selected", CSV_CONTENT: "CSV_CONTENT", BUTTON_LABEL: "BUTTON_LABEL", FILE_NAME: "FILE_NAME"}), a.service("uiGridExporterService", ["$q", "uiGridExporterConstants", "uiGridSelectionConstants", "gridUtil", "$compile", "$interval", "i18nService", function (a, b, c, d, e, f, g) {
        var h = {initializeGrid: function (a) {
            a.exporter = {}, this.defaultGridOptions(a.options);
            var b = {events: {exporter: {}}, methods: {exporter: {csvExport: function (b, c) {
                h.csvExport(a, b, c)
            ...
            a.api.core.addToGridMenu(a, [
                {title: g.getSafeText("gridMenu.exporterAllAsCsv"), action: function (a) {
                ...
                {title: g.getSafeText("gridMenu.exporterVisibleAsCsv"), action: function (a) {
                    this.grid.api.exporter.csvExport(b.VISIBLE, b.VISIBLE)
                }, shown: function () {
                    return this.grid.options.exporterMenuCsv
                }},
                {title: g.getSafeText("gridMenu.exporterSelectedAsCsv"), action: function (a) {
                ...
                {title: g.getSafeText("gridMenu.exporterAllAsPdf"), action: function (a) {
                ...
                {title: g.getSafeText("gridMenu.exporterVisibleAsPdf"), action: function (a) {
                    this.grid.api.exporter.pdfExport(b.VISIBLE, b.VISIBLE)
                }, shown: function () {
                    return this.grid.options.exporterMenuPdf
                }},
                {title: g.getSafeText("gridMenu.exporterSelectedAsPdf"), action: function (a) {
            ...
            return f.forEach(function (c, d) {
                if (c.exporterEnableExporting !== !1) {
                    var f = [];
                    a.columns.forEach(function (d, g) {
            ...
            if (!a) {
                var i = new Date;
                a = "CWS Export - " + i.getFullYear() + (i.getMonth() + 1) + i.getDate() + i.getHours() + i.getMinutes() + i.getSeconds() + ".csv"
            }
            ...
            if (navigator.msSaveBlob)return navigator.msSaveBlob(new Blob(["\ufeff", b], {type: h}), a);
            if ("download"in g) {
                var k = new Blob(["\ufeff", b], {type: h});
                d = URL.createObjectURL(k), g.setAttribute("download", a)
            ...
            if (this.isIE()) {
                pdfMake.createPdf(f).download()
            } else pdfMake.createPdf(f).open()
            ...
            }), f = c.map(this.formatRowAsPdf(this)), g = [e].concat(f), h = {pageOrientation: a.options.exporterPdfOrientation, pageSize: a.options.exporterPdfPageSize, content: [
            ...
            var b;
            return b = null == a.value ? "" : "number" == typeof a.value ? a.value.toString() : "boolean" == typeof a.value ? a.value ? "TRUE" : "FALSE" : "string" == typeof a.value ? a.value.replace(/"/g, '""') : JSON.stringify(a.value).replace(/^"/, "").replace(/"$/, ""), a.alignment && "string" == typeof a.alignment && (b = {text: b, alignment: a.alignment}), b
        }};
        return h
    }]), a.directive("uiGridExporter", ["uiGridExporterConstants", "uiGridExporterService", "gridUtil", "$compile", function (a, b, c, d) {
        return{replace: !0, priority: 0, require: "^uiGrid", scope: !1, link: function (a, c, d, e) {
            b.initializeGrid(e.grid), e.grid.exporter.$scope = a
        }}
    }])
}(), function () {
    "use strict";
    var a = angular.module("ui.grid.grouping", ["ui.grid"]);
    a.constant("uiGridGroupingConstants", {featureName: "grouping", groupingRowHeaderColName: "groupingRowHeaderCol", EXPANDED: "expanded", COLLAPSED: "collapsed", aggregation: {COUNT: "count", SUM: "sum", MAX: "max", MIN: "min", AVG: "avg", FIELD: "##@@aggregation_running_count@@##"}}), a.service("uiGridGroupingService", ["$q", "uiGridGroupingConstants", "gridUtil", "GridRow", "gridClassFactory", "i18nService", "uiGridConstants", function (a, b, c, d, e, f, g) {
        var h = {initializeGrid: function (a, b) {
            a.grouping = {}, a.grouping.numberLevels = 0, a.grouping.expandAll = !1, a.grouping.rowExpandedStates = {}, h.defaultGridOptions(a.options), a.registerRowsProcessor(h.groupRows), a.registerColumnsProcessor(h.groupingColumnProcessor);
            var c = {events: {grouping: {}}, methods: {grouping: {expandAllRows: function () {
                h.expandAllRows(a)
            }, collapseAllRows: function () {
                h.collapseAllRows(a)
            }, toggleRowGroupingState: function (b) {
                h.toggleRowGroupingState(a, b)
            }, expandRow: function (b) {
                h.expandRow(a, b)
            }, expandRowChildren: function (b) {
                h.expandRowChildren(a, b)
            }, collapseRow: function (b) {
                h.collapseRow(a, b)
            }, getGrouping: function (b) {
                var c = h.getGrouping(a);
                return c.grouping.forEach(function (a) {
                    a.colName = a.col.name, delete a.col
                }), c.aggregations.forEach(function (a) {
                    a.colName = a.col.name, delete a.col
                }), b && (c.rowExpandedStates = a.grouping.rowExpandedStates), c
                ...
                h.clearGrouping(a)
            }, aggregateColumn: function (b, c) {
                var d = a.getColumn(b);
                h.aggregateColumn(a, d, c)
            }}}};
            a.api.registerEventsFromObject(c.events),
                a.api.registerMethodsFromObject(c.methods), a.api.core.on.sortChanged(b, h.tidyPriorities)
        }, defaultGridOptions: function (a) {
            a.enableGrouping = a.enableGrouping !== !1, a.groupingRowHeaderBaseWidth = a.groupingRowHeaderBaseWidth || 30, a.groupingIndent = a.groupingIndent || 10, a.groupingRowHeaderAlwaysVisible = a.groupingRowHeaderAlwaysVisible === !0, a.groupingShowCounts = a.groupingShowCounts !== !1
            ...
            if (a.enableGrouping !== !1) {
                ...
                var g = {name: "ui.grid.grouping.group", title: f.get().grouping.group, icon: "ui-grid-icon-indent-right", shown: function () {
                    ...
                    h.groupColumn(this.context.col.grid, this.context.col)
                }}, i = {name: "ui.grid.grouping.ungroup", title: f.get().grouping.ungroup, icon: "ui-grid-icon-indent-left", shown: function () {
                    return"undefined" != typeof this.context.col.grouping && "undefined" != typeof this.context.col.grouping.groupPriority && this.context.col.grouping.groupPriority >= 0
                }, action: function () {
                    h.ungroupColumn(this.context.col.grid, this.context.col)
                }}, j = {name: "ui.grid.grouping.aggregateRemove", title: f.get().grouping.aggregate_remove, shown: function () {
                    return"undefined" != typeof this.context.col.grouping && "undefined" != typeof this.context.col.grouping.aggregation && null !== this.context.col.grouping.aggregation
                }, action: function () {
                    h.aggregateColumn(this.context.col.grid, this.context.col, null)
                }}, k = function (a) {
                    var b = {name: "ui.grid.grouping.aggregate" + a, title: f.get().grouping["aggregate_" + a], shown: function () {
                        return"undefined" == typeof this.context.col.grouping || "undefined" == typeof this.context.col.grouping.aggregation || this.context.col.grouping.aggregation !== a
                    }, action: function () {
                        h.aggregateColumn(this.context.col.grid, this.context.col, a)
                    }};
                    c.arrayContainsObjectWithProperty(d.menuItems, "name", "ui.grid.grouping.aggregate" + a) || d.menuItems.push(b)
                };
                c.arrayContainsObjectWithProperty(d.menuItems, "name", "ui.grid.grouping.group") || d.menuItems.push(g), c.arrayContainsObjectWithProperty(d.menuItems, "name", "ui.grid.grouping.ungroup") || d.menuItems.push(i), k(b.aggregation.COUNT), k(b.aggregation.SUM), k(b.aggregation.MAX), k(b.aggregation.MIN), k(b.aggregation.AVG), c.arrayContainsObjectWithProperty(d.menuItems, "name", "ui.grid.grouping.aggregateRemove") || d.menuItems.push(j)
            }
        }, groupingColumnProcessor: function (a, c) {
            var d = this;
            return a.forEach(function (a, c) {
                if (a.groupingPosition = c, a.name === b.groupingRowHeaderColName) {
                    var e = h.getGrouping(a.grid);
                    ("undefined" == typeof d.options.groupingRowHeaderAlwaysVisible || d.options.groupingRowHeaderAlwaysVisible === !1) && (a.visible = e.grouping.length > 0 ? !0 : !1);
                    var f = (e.grouping.length - 1) * d.options.groupingIndent;
                    f = f > 0 ? f : 0, a.width = d.options.groupingRowHeaderBaseWidth + f
                }
            }), a = h.moveGroupColumns(this, a, c)
        }, moveGroupColumns: function (a, b, c) {
            return a.options.moveGroupColumns !== !1 ? (b.sort(function (a, b) {
                var c, d;
        ...
        }, groupColumn: function (a, b) {
            "undefined" == typeof b.grouping && (b.grouping = {});
            var c = h.getGrouping(a);
            b.grouping.groupPriority = c.grouping.length, b.sort ? ("undefined" == typeof b.sort.direction || null === b.sort.direction) && (b.sort.direction = g.ASC) : b.sort = {direction: g.ASC}, h.tidyPriorities(a), a.queueGridRefresh()
        }, ungroupColumn: function (a, b) {
            "undefined" != typeof b.grouping && (delete b.grouping.groupPriority, h.tidyPriorities(a), a.queueGridRefresh())
        }, aggregateColumn: function (a, b, c) {
            "undefined" == typeof b.grouping && (b.grouping = {}), "undefined" != typeof b.grouping.groupPriority && b.grouping.groupPriority >= 0 && h.ungroupColumn(a, b), b.grouping.aggregation = c, a.queueGridRefresh()
        }, setGrouping: function (a, b) {
            "undefined" != typeof b && (h.clearGrouping(a), b.grouping && b.grouping.length && b.grouping.length > 0 && b.grouping.forEach(function (b) {
                var c = a.getColumn(b.colName);
                c && h.groupColumn(a, c)
            }), b.aggregations && b.aggregations.length && b.aggregations.length > 0 && b.aggregations.forEach(function (b) {
                var c = a.getColumn(b.colName);
                c && h.aggregateColumn(a, c, b.aggregation)
            }), b.rowExpandedStates && (a.grouping.rowExpandedStates = b.rowExpandedStates))
        }, clearGrouping: function (a) {
            var b = h.getGrouping(a);
            b.grouping.length > 0 && b.grouping.forEach(function (b) {
                b.col || (b.col = a.getColumn(b.colName)), h.ungroupColumn(a, b.col)
            }), b.aggregations.length > 0 && b.aggregations.forEach(function (b) {
                b.col || (b.col = a.getColumn(b.colName)), h.aggregateColumn(a, b.col, null)
            })
        }, tidyPriorities: function (a) {
            "undefined" == typeof a && "undefined" != typeof this.grid && (a = this.grid);
            var b = [], c = [];
            ...
            h.setAllNodes(a.grouping.rowExpandedStates, b.EXPANDED), a.queueGridRefresh()
        }, collapseAllRows: function (a) {
            h.setAllNodes(a.grouping.rowExpandedStates, b.COLLAPSED), a.queueGridRefresh()
        }, setAllNodes: function (a, b) {
            a.state = b, angular.forEach(a, function (a, c) {
                "state" !== c && h.setAllNodes(a, b)
            })
        }, toggleRowGroupingState: function (a, c) {
            c.groupHeader && (c.expandedState.state = c.expandedState.state === b.EXPANDED ? b.COLLAPSED : b.EXPANDED, a.queueGridRefresh())
        }, expandRow: function (a, c) {
            c.groupHeader && (c.expandedState.state = b.EXPANDED, a.queueGridRefresh())
        }, expandRowChildren: function (a, c) {
            c.groupHeader && (h.setAllNodes(c.expandedState, b.COLLAPSED), a.queueGridRefresh())
        }, collapseRow: function (a, c) {
            c.groupHeader && (c.expandedState.state = b.COLLAPSED, a.queueGridRefresh())
        }, collapseRowChildren: function (a, c) {
            c.groupHeader && (h.setAllNodes(c.expandedState, b.COLLAPSED), a.queueGridRefresh())
        }, groupRows: function (a) {
            if (0 === a.length)return a;
            for (var b = this, c = h.initialiseProcessingState(b), d = function (d, g) {
                var i = b.getCellValue(f, d.col);
                "undefined" != typeof i && null !== i && f.visible && (d.initialised && i === d.currentValue || (h.insertGroupHeader(b, a, e, c, g), e++), h.aggregate(b, f, d))
            }, e = 0; e < a.length; e++) {
                var f = a[e];
                c.forEach(d), h.setVisibility(b, f, c)
            }
            return h.writeOutAggregations(b, c, 0), a
        }, initialiseProcessingState: function (a) {
            var c = [], d = h.getGrouping(a);
            return d.grouping.forEach(function (e, f) {
                var g = [];
                a.options.groupingShowCounts && g.push({type: b.aggregation.COUNT, fieldName: b.aggregation.FIELD, value: null}), d.aggregations.forEach(function (a, c) {
                    g.push(a.aggregation === b.aggregation.AVG ? {type: a.aggregation, fieldName: a.field, col: a.col, value: null, sum: null, count: null} : {type: a.aggregation, fieldName: a.field, col: a.col, value: null})
                }), c.push({fieldName: e.field, col: e.col, initialised: !1, currentValue: null, currentGroupHeader: null, runningAggregations: g})
            }), c
        }, getGrouping: function (a) {
            var b = [], c = [];
            return a.columns.forEach(function (a, d) {
                a.grouping && ("undefined" != typeof a.grouping.groupPriority && a.grouping.groupPriority >= 0 ? b.push({field: a.field, col: a, groupPriority: a.grouping.groupPriority, grouping: a.grouping}) : a.grouping.aggregation && c.push({field: a.field, col: a, aggregation: a.grouping.aggregation}))
            }), b.sort(function (a, b) {
                return a.groupPriority - b.groupPriority
            }), b.forEach(function (a, b) {
                a.grouping.groupPriority = b, a.groupPriority = b, delete a.grouping
            }), {grouping: b, aggregations: c}
        }, insertGroupHeader: function (a, b, c, f, g) {
            h.writeOutAggregations(a, f, g);
            var i = new d({}, null, a);
            e.rowTemplateAssigner.call(a, i);
            var j = f[g].fieldName, k = f[g].col, l = a.getCellValue(b[c], k);
            i.entity[j] = l, i.groupLevel = g, i.groupHeader = !0, i.internalRow = !0, i.enableEditing = !1, i.enableSelection = !1, f[g].initialised = !0, f[g].currentValue = l, f[g].currentGroupHeader = i, i.expandedState = h.getExpandedState(a, f, g), h.setVisibility(a, i, f), b.splice(c, 0, i)
        }, writeOutAggregations: function (a, b, c) {
            for (var d = c; d < b.length; d++)h.writeOutAggregation(a, b[d])
        }, writeOutAggregation: function (a, c) {
            c.currentGroupHeader && c.runningAggregations.forEach(function (a, d) {
                a.fieldName === b.aggregation.FIELD ? (c.currentGroupHeader.entity[c.fieldName] = c.currentValue + " (" + a.value + ")", a.value = null) : (c.currentGroupHeader.entity[a.fieldName] = a.col.groupingSuppressAggregationText ? a.value : f.get().aggregation[a.type] + a.value, a.value = null, a.sum && (a.sum = null), a.count && (a.count = null))
            }), c.currentGroupHeader = null, c.currentValue = null, c.initialised = !1
        }, getExpandedState: function (a, c, d) {
            for (var e = a.grouping.rowExpandedStates, f = 0; d >= f; f++)e[c[f].currentValue] || (e[c[f].currentValue] = {state: b.COLLAPSED}), e = e[c[f].currentValue];
            return e
        }, setVisibility: function (a, c, d) {
            if (c.visible) {
                for (var e = !0, f = "undefined" != typeof c.groupLevel ? c.groupLevel : d.length, g = 0; f > g; g++)d[g].currentGroupHeader.expandedState.state === b.COLLAPSED && (e = !1);
                e || c.setThisRowInvisible("grouping", !0)
            }
        }, aggregate: function (a, c, d) {
            d.runningAggregations.forEach(function (d, e) {
                if (d.type === b.aggregation.COUNT)d.value++; else {
                    var f = a.getCellValue(c, d.col), g = Number(f);
                    switch (d.type) {
                        case b.aggregation.SUM:
                            isNaN(g) || (d.value += g);
                            break;
                        case b.aggregation.MIN:
                            void 0 !== f && null !== f && (f < d.value || null === d.value) && (d.value = f);
                            break;
                        case b.aggregation.MAX:
                            void 0 !== f && f > d.value && (d.value = f);
                            break;
                        case b.aggregation.AVG:
                            d.count++, isNaN(g) || (d.sum += g), d.value = d.sum / d.count
                    }
                }
            })
        }};
        ...
        return{replace: !0, priority: 0, require: "^uiGrid", scope: !1, compile: function () {
            return{pre: function (c, d, e, f) {
                if (f.grid.options.enableGrouping !== !1) {
                    b.initializeGrid(f.grid, c);
                    var g = {name: a.groupingRowHeaderColName, displayName: "", width: f.grid.options.groupingRowHeaderWidth, minWidth: 10, cellTemplate: "ui-grid/groupingRowHeader", headerCellTemplate: "ui-grid/groupingHeaderCell", enableColumnResizing: !1, enableColumnMenu: !1, exporterSuppressExport: !0, allowCellFocus: !0};
                    f.grid.addRowHeaderColumn(g), f.grid.registerColumnBuilder(b.groupingColumnBuilder)
                }
            }, post: function (a, b, c, d) {
            }}
        }}
    }]), a.directive("uiGridGroupingRowHeaderButtons", ["$templateCache", "uiGridGroupingService", function (a, b) {
        return{replace: !0, restrict: "E", template: a.get("ui-grid/groupingRowHeaderButtons"), scope: !0, require: "^uiGrid", link: function (a, c, d, e) {
            var f = e.grid;
            a.groupButtonClick = function (a, c) {
                b.toggleRowGroupingState(f, a, c)
            }
        }}
    }]), a.directive("uiGridGroupingExpandAllButtons", ["$templateCache", "uiGridGroupingService", function (a, b) {
        return{replace: !0, restrict: "E", template: a.get("ui-grid/groupingExpandAllButtons"), scope: !1, link: function (a, c, d, e) {
            var f = a.col.grid;
            a.headerButtonClick = function (a, c) {
                f.grouping.expandAll ? (b.collapseAllRows(f, c), f.grouping.expandAll = !1) : (b.expandAllRows(f, c), f.grouping.expandAll = !0)
            }
        }}
    }]), a.directive("uiGridViewport", ["$compile", "uiGridConstants", "uiGridGroupingConstants", "gridUtil", "$parse", "uiGridGroupingService", function (a, b, c, d, e, f) {
        return{priority: -200, scope: !1, compile: function (a, b) {
            var c = angular.element(a.children().children()[0]), d = c.attr("ng-class"), e = "";
            return e = d ? d.slice(0, -1) + ",'ui-grid-group-header-row': row.groupLevel > -1}" : "{'ui-grid-group-header-row': row.groupLevel > -1}", c.attr("ng-class", e), {pre: function (a, b, c, d) {
            }, post: function (a, b, c, d) {
            }}
        }}
    }])
    ...
    a.constant("uiGridImporterConstants", {featureName: "importer"}), a.service("uiGridImporterService", ["$q", "uiGridConstants", "uiGridImporterConstants", "gridUtil", "$compile", "$interval", "i18nService", "$window", function (a, b, c, d, e, f, g, h) {
        var i = {initializeGrid: function (a, b) {
            b.importer = {$scope: a}, this.defaultGridOptions(b.options);
            var c = {events: {importer: {}}, methods: {importer: {importFile: function (a) {
        ...
        return{replace: !0, priority: 0, require: "^uiGrid", scope: !1, templateUrl: "ui-grid/importerMenuItem", link: function (a, d, e, f) {
            var g = function (a) {
    ...
    a.service("uiGridInfiniteScrollService", ["gridUtil", "$compile", "$timeout", "uiGridConstants", "ScrollEvent", "$q", function (a, b, c, d, e, f) {
        var g = {initializeGrid: function (a, b) {
            if (g.defaultGridOptions(a.options), a.options.enableInfiniteScroll) {
                a.infiniteScroll = {dataLoading: !1}, g.setScrollDirections(a, a.options.infiniteScrollUp, a.options.infiniteScrollDown), a.api.core.on.scrollEvent(b, g.handleScroll);
                var c = {events: {infiniteScroll: {needLoadMoreData: function (a, b) {
                }, needLoadMoreDataTop: function (a, b) {
                }}}, methods: {infiniteScroll: {dataLoaded: function (b, c) {
            ...
            return c(function () {
                ...
                var e, f, h = a.renderContainers.body.visibleRowCache.length;
                a.infiniteScroll.direction === d.scrollDirection.UP && (console.log("prevTop was: " + a.infiniteScroll.prevScrolltopPercentage), console.log("grid was: " + a), e = a.infiniteScroll.prevScrolltopPercentage || 0, f = e * a.infiniteScroll.previousVisibleRows, c = (h - a.infiniteScroll.previousVisibleRows + f) / h, g.adjustInfiniteScrollPosition(a, c).then(function () {
                    b.resolve()
                })), a.infiniteScroll.direction === d.scrollDirection.DOWN && (e = a.infiniteScroll.prevScrolltopPercentage || 1, f = e * a.infiniteScroll.previousVisibleRows, c = f / h, g.adjustInfiniteScrollPosition(a, c).then(function () {
                    b.resolve()
                }))
            }, 0), b.promise
        }, adjustInfiniteScrollPosition: function (a, b) {
            var d = new e(a, null, null, "ui.grid.adjustInfiniteScrollPosition");
            d.y = 0 === b && a.infiniteScroll.scrollUp ? {pixels: 1} : {percentage: b}, d.fireScrollingEvent();
            var g = f.defer();
            return c(function () {
                g.resolve()
            }), g.promise
            ...
            g.setScrollDirections(a, b, c);
            var d = a.renderContainers.body.visibleRowCache.length, e = a.infiniteScroll.prevScrolltopPercentage * a.infiniteScroll.prevVisibleRows, f = e - (a.infiniteScroll.prevVisibleRows - d), h = f / d;
            return g.adjustInfiniteScrollPosition(a, h)
        }, dataRemovedBottom: function (a, b, c) {
            g.setScrollDirections(a, b, c);
            var d = a.renderContainers.body.visibleRowCache.length, e = a.infiniteScroll.prevScrolltopPercentage * a.infiniteScroll.prevVisibleRows, f = e / d;
    ...
    a.service("uiGridMoveColumnService", ["$q", "$timeout", "$log", "ScrollEvent", "uiGridConstants", "gridUtil", function (a, b, c, d, e, f) {
        var g = {initializeGrid: function (a) {
            ...
            var b = this, c = {events: {colMovable: {columnPositionChanged: function (a, b, c) {
            ...
            return{post: function (a, e, f, h) {
                if (a.col.colDef.enableColumnMoving) {
                    var i, j, k, l, m, n, o = angular.element(e[0].querySelectorAll(".ui-grid-cell-contents")), p = !1, q = !1, r = function (b) {
                        i = a.grid.element[0].getBoundingClientRect().left, j = b.pageX, k = 0, l = i + a.grid.getViewportWidth(), "mousedown" === b.type ? (d.on("mousemove", s), d.on("mouseup", t)) : "touchstart" === b.type && (d.on("touchmove", s), d.on("touchend", t))
                    }, s = function (a) {
                    ...
                    var w = function () {
                        ...
                        var j, o = m[0].getBoundingClientRect().left - 1, p = m[0].getBoundingClientRect().right;
                        if (j = "ie" === b.detectBrowser() ? o + c : o - i + c, j = l > j ? j : l, (o >= i || c > 0) && (l >= p || 0 > c))m.css({visibility: "visible", left: j + "px"}); else if (e > Math.ceil(h.grid.gridWidth)) {
                            c *= 8;
                        ...
                        void 0 === a.newScrollLeft ? k += c : k = a.newScrollLeft + j - r, n < a.col.drawnWidth && (n += Math.abs(c), m.css({width: n + "px"}))
                    }
                }
            }}
        }}
    ...
    a.service("uiGridPaginationService", ["gridUtil", function (a) {
        var b = {initializeGrid: function (a) {
            b.defaultGridOptions(a.options);
            var c = {events: {pagination: {paginationChanged: function (a, b) {
            }}}, methods: {pagination: {getPage: function () {
        ...
        return{priority: -200, scope: !1, require: "uiGrid", link: {pre: function (c, d, e, f) {
        ...
        return{priority: -200, scope: !0, require: "^uiGrid", link: function (e, f, g, h) {
    ...
    a.service("uiGridPinningService", ["gridUtil", "GridRenderContainer", "i18nService", function (a, b, c) {
        var d = {initializeGrid: function (a) {
            ...
            if (b.enablePinning = void 0 === b.enablePinning ? e.enablePinning : b.enablePinning, b.pinnedLeft ? "*" === d.width ? d.grid.refresh().then(function () {
                d.renderContainer = "left", d.grid.createLeftContainer()
            }) : (d.renderContainer = "left", d.grid.createLeftContainer()) : b.pinnedRight && ("*" === d.width ? d.grid.refresh().then(function () {
                d.renderContainer = "right", d.grid.createRightContainer()
            }) : (d.renderContainer = "right", d.grid.createRightContainer())), b.enablePinning) {
                var f = {name: "ui.grid.pinning.pinLeft", title: c.get().pinning.pinLeft, icon: "ui-grid-icon-left-open", shown: function () {
                    ...
                    this.context.col.renderContainer = "left", this.context.col.width = this.context.col.drawnWidth, this.context.col.grid.createLeftContainer(), d.grid.refresh()
                }}, g = {name: "ui.grid.pinning.pinRight", title: c.get().pinning.pinRight, icon: "ui-grid-icon-right-open", shown: function () {
                    ...
                    this.context.col.renderContainer = "right", this.context.col.width = this.context.col.drawnWidth, this.context.col.grid.createRightContainer(), d.grid.refresh()
                }}, h = {name: "ui.grid.pinning.unpin", title: c.get().pinning.unpin, icon: "ui-grid-icon-cancel", shown: function () {
                    ...
                    this.context.col.renderContainer = null, d.grid.refresh()
                }};
    ...
    a.service("uiGridResizeColumnsService", ["gridUtil", "$q", "$timeout", function (a, b, c) {
        var d = {defaultGridOptions: function (a) {
        ...
        var e = angular.element('<div class="ui-grid-resize-overlay"></div>'), f = {priority: 0, scope: {col: "=", position: "@", renderIndex: "="}, require: "?^uiGrid", link: function (f, g, h, i) {
            function j(a) {
    ...
    a.constant("uiGridRowEditConstants", {}), a.service("uiGridRowEditService", ["$interval", "$q", "uiGridConstants", "uiGridRowEditConstants", "gridUtil", function (a, b, c, d, e) {
        var f = {initializeGrid: function (a, b) {
            b.rowEdit = {};
            var c = {events: {rowEdit: {saveRow: function (a) {
            }}}, methods: {rowEdit: {setSavePromise: function (a, c) {
        ...
        return{priority: -200, scope: !1, compile: function (a, b) {
            var c = angular.element(a.children().children()[0]), d = c.attr("ng-class"), e = "";
            return e = d ? d.slice(0, -1) + ", 'ui-grid-row-dirty': row.isDirty, 'ui-grid-row-saving': row.isSaving, 'ui-grid-row-error': row.isError}" : "{'ui-grid-row-dirty': row.isDirty, 'ui-grid-row-saving': row.isSaving, 'ui-grid-row-error': row.isError}", c.attr("ng-class", e), {pre: function (a, b, c, d) {
            }, post: function (a, b, c, d) {
            }}
        }}
    }])
    ...
    "use strict";
    var a = angular.module("ui.grid.saveState", ["ui.grid", "ui.grid.selection", "ui.grid.cellNav", "ui.grid.grouping"]);
    a.constant("uiGridSaveStateConstants", {featureName: "saveState"}), a.service("uiGridSaveStateService", ["$q", "uiGridSaveStateConstants", "gridUtil", "$compile", "$interval", "uiGridConstants", function (a, b, c, d, e, f) {
        var g = {initializeGrid: function (a) {
            ...
            var b = {events: {saveState: {}}, methods: {saveState: {save: function () {
                return g.save(a)
            ...
            a.saveWidths = a.saveWidths !== !1, a.saveOrder = a.saveOrder !== !1, a.saveScroll = a.saveScroll === !0, a.saveFocus = a.saveScroll !== !0 && a.saveFocus !== !1, a.saveVisible = a.saveVisible !== !1, a.saveSort = a.saveSort !== !1, a.saveFilter = a.saveFilter !== !1, a.saveSelection = a.saveSelection !== !1, a.saveGrouping = a.saveGrouping !== !1, a.saveGroupingExpandedStates = a.saveGroupingExpandedStates === !0
        }, save: function (a) {
            var b = {};
            return b.columns = g.saveColumns(a), b.scrollFocus = g.saveScrollFocus(a), b.selection = g.saveSelection(a), b.grouping = g.saveGrouping(a), b
        }, restore: function (a, b, c) {
            c.columns && g.restoreColumns(a, c.columns), c.scrollFocus && g.restoreScrollFocus(a, b, c.scrollFocus), c.selection && g.restoreSelection(a, c.selection), c.grouping && g.restoreGrouping(a, c.grouping), a.queueGridRefresh()
        }, saveColumns: function (a) {
            var b = [];
            return a.columns.forEach(function (c) {
                var d = {};
                d.name = c.name, a.options.saveVisible && (d.visible = c.visible), a.options.saveWidths && (d.width = c.width), a.options.saveSort && (d.sort = angular.copy(c.sort)), a.options.saveFilter && (d.filters = angular.copy(c.filters)), b.push(d)
            }), b
            ...
            if (a.api.cellNav) {
                ...
                (d || h) && (c.focus ? a.api.cellNav.scrollToFocus(h, d) : a.api.cellNav.scrollTo(h, d))
            }
    ...
    a.constant("uiGridSelectionConstants", {featureName: "selection", selectionRowHeaderColName: "selectionRowHeaderCol"}), angular.module("ui.grid").config(["$provide", function (a) {
        ...
        var e = {initializeGrid: function (a) {
            ...
            var b = {events: {selection: {rowSelectionChanged: function (a, b, c) {
            }, rowSelectionChangedBatch: function (a, b, c) {
            }}}, methods: {selection: {toggleRowSelection: function (b, c) {
                var d = a.getRow(b);
                null !== d && d.enableSelection !== !1 && e.toggleRowSelection(a, d, c, a.options.multiSelect, a.options.noUnselect)
            }, selectRow: function (b, c) {
                var d = a.getRow(b);
                null === d || d.isSelected || d.enableSelection === !1 || e.toggleRowSelection(a, d, c, a.options.multiSelect, a.options.noUnselect)
            }, selectRowByVisibleIndex: function (b, c) {
                var d = a.renderContainers.body.visibleRowCache[b];
                null === d || "undefined" == typeof d || d.isSelected || d.enableSelection === !1 || e.toggleRowSelection(a, d, c, a.options.multiSelect, a.options.noUnselect)
            ...
            g && f || b.enableSelection !== !1 && (b.setSelected(!g), b.isSelected === !0 ? a.selection.lastSelectedRow = b : a.selection.selectAll = !1, a.api.selection.raise.rowSelectionChanged(b, c))
        ...
        return{replace: !0, priority: 0, require: "^uiGrid", scope: !1, compile: function () {
            return{pre: function (c, e, f, g) {
                ...
                var i = !1, j = function () {
                    g.grid.options.isRowSelectable !== angular.noop && i !== !0 && (g.grid.registerRowsProcessor(function (a) {
                        return a.forEach(function (a) {
                ...
                j();
                var k = g.grid.registerDataChangeCallback(j, [d.dataChange.OPTIONS]);
                c.$on("$destroy", k)
            }, post: function (a, b, c, d) {
            }}
        }}
    }]), a.directive("uiGridSelectionRowHeaderButtons", ["$templateCache", "uiGridSelectionService", function (a, b) {
        return{replace: !0, restrict: "E", template: a.get("ui-grid/selectionRowHeaderButtons"), scope: !0, require: "^uiGrid", link: function (a, c, d, e) {
            var f = e.grid;
            a.selectButtonClick = function (a, c) {
                c.stopPropagation(), c.shiftKey ? b.shiftSelect(f, a, c, f.options.multiSelect) : c.ctrlKey || c.metaKey ? b.toggleRowSelection(f, a, c, f.options.multiSelect, f.options.noUnselect) : b.toggleRowSelection(f, a, c, f.options.multiSelect && !f.options.modifierKeysToMultiSelect, f.options.noUnselect)
            }
        }}
    }]), a.directive("uiGridSelectionSelectAllButtons", ["$templateCache", "uiGridSelectionService", function (a, b) {
        return{replace: !0, restrict: "E", template: a.get("ui-grid/selectionSelectAllButtons"), scope: !1, link: function (a, c, d, e) {
            var f = a.col.grid;
            a.headerButtonClick = function (a, c) {
        ...
        return{priority: -200, restrict: "A", scope: !1, link: function (a, c, d) {
            function e() {
                a.grid.options.enableRowSelection && !a.grid.options.enableRowHeaderSelection && (c.addClass("ui-grid-disable-selection"), c.on("touchstart", l), c.on("touchend", m), c.on("click", k), a.registered = !0)
            }

            function h() {
                a.registered && (c.removeClass("ui-grid-disable-selection"), c.off("touchstart", l), c.off("touchend", m), c.off("click", k), a.registered = !1)
            }

            var i = 0, j = 300;
            c.bind("keydown", function (b) {
                32 === b.keyCode && "selectionRowHeaderCol" === a.col.colDef.name && (f.toggleRowSelection(a.grid, a.row, b, a.grid.options.multiSelect && !a.grid.options.modifierKeysToMultiSelect, a.grid.options.noUnselect), a.$apply())
            });
            var k = function (b) {
                c.off("touchend", m), b.shiftKey ? f.shiftSelect(a.grid, a.row, b, a.grid.options.multiSelect) : b.ctrlKey || b.metaKey ? f.toggleRowSelection(a.grid, a.row, b, a.grid.options.multiSelect, a.grid.options.noUnselect) : f.toggleRowSelection(a.grid, a.row, b, a.grid.options.multiSelect && !a.grid.options.modifierKeysToMultiSelect, a.grid.options.noUnselect), a.$apply(), g(function () {
                    c.on("touchend", m)
                }, j)
            }, l = function (a) {
                i = (new Date).getTime(), c.off("click", k)
            }, m = function (a) {
                var b = (new Date).getTime(), d = b - i;
                j > d && k(a), g(function () {
                    c.on("click", k)
                }, j)
            };
            e();
            var n = a.grid.registerDataChangeCallback(function () {
                !a.grid.options.enableRowSelection || a.grid.options.enableRowHeaderSelection || a.registered ? a.grid.options.enableRowSelection && !a.grid.options.enableRowHeaderSelection || !a.registered || h() : e()
            }, [b.dataChange.OPTIONS]);
            c.on("$destroy", n)
        }}
    }]), a.directive("uiGridGridFooter", ["$compile", "uiGridConstants", "gridUtil", function (a, b, c) {
        return{restrict: "EA", replace: !0, priority: -1e3, require: "^uiGrid", scope: !0, compile: function (b, d) {
    ...
    a.put("ui-grid/ui-grid-footer", '<div class="ui-grid-footer-panel ui-grid-footer-aggregates-row"><div class="ui-grid-footer ui-grid-footer-viewport"><div class="ui-grid-footer-canvas"><div class="ui-grid-footer-cell-wrapper" ng-style="colContainer.headerCellWrapperStyle()"><div class="ui-grid-footer-cell-row"><div ng-repeat="col in colContainer.renderedColumns track by col.colDef.name" ui-grid-footer-cell col="col" render-index="$index" class="ui-grid-footer-cell ui-grid-clearfix"></div></div></div></div></div></div>'),
        ...
        a.put("ui-grid/expandableRow", '<div ui-grid-expandable-row ng-if="expandableRow.shouldRenderExpand()" class="expandableRow" style="float:left; margin-top: 1px; margin-bottom: 1px;" ng-style="{width: (grid.renderContainers.body.getCanvasWidth()) + \'px\', height: (row.entity.subGridOptions.data.length*row.entity.subGridOptions.expandableRowHeight)+ \'px\'}"></div>'),
        a.put("ui-grid/expandableRowHeader", '<div class="ui-grid-row-header-cell ui-grid-expandable-buttons-cell"><div class="ui-grid-cell-contents"><i ng-class="{ \'ui-grid-icon-plus-squared1\' : !row.isExpanded, \'ui-grid-icon-minus-squared1\' : row.isExpanded }" ng-click="grid.api.expandable.toggleRowExpansion(row.entity)"></i></div></div>'),
        a.put("ui-grid/expandableScrollFiller", "<div ng-if=\"expandableRow.shouldRenderFiller()\" style=\"float:left;\" ng-style=\"{ width: (grid.getViewportWidth()) + 'px',\n  height: (row.entity.subGridOptions.data.length*row.entity.subGridOptions.expandableRowHeight+2)+ 'px', 'margin-left': grid.options.rowHeader.rowHeaderWidth + 'px' ,'background':'#ffffff'}\"><i class=\"ui-grid-icon-spin5 ui-grid-animate-spin\" ng-style=\"{ 'margin-top': ( grid.options.expandableRowHeight/2 - 5) + 'px',\n            'margin-left' : ((grid.getViewportWidth() - grid.options.rowHeader.rowHeaderWidth)/2 - 5) + 'px' }\"></i></div>"),
        a.put("ui-grid/expandableTopRowHeader", '<div class="ui-grid-row-header-cell ui-grid-expandable-buttons-cell"><div class="ui-grid-cell-contents"><i ng-class="{ \'ui-grid-icon-plus-squared1\' : !grid.expandable.expandedAll, \'ui-grid-icon-minus-squared1\' : grid.expandable.expandedAll }" ng-click="grid.api.expandable.toggleAllRows()"></i></div></div>'),
        ...
        a.put("ui-grid/groupingExpandAllButtons", '<div class="ui-grid-grouping-row-header-buttons" ng-class="{\'ui-grid-icon-minus-squared1\': grid.grouping.expandAll, \'ui-grid-icon-plus-squared1\': !grid.grouping.expandAll}" ng-click="headerButtonClick($event)"></div>'),
        ...
        a.put("ui-grid/groupingRowHeaderButtons", "<div class=\"ui-grid-grouping-row-header-buttons\" ng-class=\"{'ui-grid-group-header': row.groupLevel > - 1}\" ng-click=\"groupButtonClick(row, $event)\"><i ng-class=\"{'ui-grid-icon-minus-squared1': row.expandedState.state === 'expanded', 'ui-grid-icon-plus-squared1': row.expandedState.state === 'collapsed'}\" ng-style=\"{'padding-left': grid.options.groupingIndent * row.groupLevel + 'px'}\"></i> &nbsp;</div>"),
        ...
        a.put("ui-grid/selectionRowHeaderButtons", '<div class="ui-grid-selection-row-header-buttons ui-grid-icon-ok" ng-class="{\'ui-grid-row-selected\': row.isSelected}" ng-click="selectButtonClick(row, $event)">&nbsp;</div>'), a.put("ui-grid/selectionSelectAllButtons", '<div class="ui-grid-selection-row-header-buttons ui-grid-icon-ok" ng-class="{\'ui-grid-all-selected\': grid.selection.selectAll}" ng-click="headerButtonClick($event)"></div>')
}]);