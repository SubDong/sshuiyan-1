...
(function (root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['angularjs/moment.min', 'jquery', 'exports'], function (momentjs, $, exports) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
            '<div class="calendar_box"><div class="calendar first left">' +
            '</div>' +
            ...
            '<input class="input-mini" type="text" name="daterangepicker_start" value="" /><span>-</span>' +
            '</div>' +
