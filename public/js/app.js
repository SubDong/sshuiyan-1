 ...
 */
define(["angular", "js001", "js002", "js003", "js004", "js005", "js006", "js007", "angularjs/ui-bootstrap.min", "angularjs/ui-bootstrap-tpls", "angularjs/ui-grid-unstable.min", "angularjs/checkbox", "angularjs/moment.min", "angularjs/daterangepicker", "heatmap/heatmap", "controller/index", "controller/source/index", "controller/trend/index", "controller/page/index", "controller/value/index", "controller/visitor/index", "controller/conf/index"], function (ng) {
    'use strict';


    var myApp = ng.module("myApp", ["app.controllers", "source.controllers", "trend.controllers", 'page.controllers', 'value.controllers', 'visitor.controllers', 'conf.controllers', 'ui.router', 'ui.grid', 'ui.grid.autoResize', 'ui.grid.grouping', 'ui.grid.expandable', 'ui.grid.pagination', 'ui.bootstrap', 'ngDialog', 'ngSanitize', 'ui.select']);
