/**
 * Created by TomDing on 10/10/2015.
 */
...
bufferutils.prototype.concat = function (buffer) {
...
bufferutils.prototype._concat = function (buffer) {
...
bufferutils.prototype._toBuffer = function () {
    var data = null;
...
bufferutils.prototype.toBuffer = function () {
    return this._status === "computed" ? this.buffer : this._toBuffer();
};

bufferutils.prototype.toString = function () {
