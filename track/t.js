    ...
    (function () {
                ...
                init: function () {
                    ...
                    if (l[1] != undefined && l[1] != "" && l[1] != null) {
                        if (l[2] != undefined && l[2] != "" && l[2] != null) {
                            g.g.dt = new Date().getTime();
                            2 < l.length && (g.g.api = "2_0", g.g.et = c(l[1]) + "*" + c(l[2]) + (l[3] ? "*" + c(l[3]) : "") + (l[4] ? "*" + c(l[4]) : ""), d.b.init())
                        }
                    }
        ...
        if (config != undefined && config.evt != undefined && config.evt.length > 0) {
            window.onload = function () {
                config.evt.forEach(function (k, h) {
                    var l = d.I.protocol + "//" + document.location.hostname;
                    if (l === k.evpage) {
                        ...
                        if (m != undefined && m != null) {
                            if (c == null) {
                                m.onclick = function () {
                                    _pct.putPar(["_trackEvent", k.eid, k.evttag])
                                }
                            } else {
        ...
        if (config != undefined) {
            if (!g.g.loc.indexOf("www.farmer.com.cn")) {
                (function () {
                    var c = document.createElement("img");
                    c.src = "http://hy.best-ad.cn/img/" + (config.iconNumber != undefined ? config.iconNumber : "1") + ".gif";
